...
//  InnSight
//
//  Formulario para editar un hotel existente
//
...
struct EditHotelView: View {
    ...
    init(hotel: Hotel, viewModel: AdminViewModel) {
        ...
        _imageUrl = State(initialValue: hotel.imageUrl ?? "")
    }
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        .accessibilityHint(isValid ? "Toca para guardar los cambios del hotel" : "El nombre del hotel es requerido")
                    }
                }
            }
